...
_HEADERS = {
    # Linux UA: DDG currently blocks some "Windows" User-Agents with 403
    # on the hidden i.js endpoint. A modern Linux Chrome UA works
    # reliably across requests. Keep the headers minimal but include
    # Referer/Origin so DDG serves a non-bot page on the vqd request.
    "User-Agent": (
